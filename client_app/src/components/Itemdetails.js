...
const RenderView = () => {
  ...
  return <div class="bg-white shadow overflow-hidden sm:rounded-lg w-6/12 right">
    <div class="px-4 py-5 sm:px-6">
      <h3 class="text-lg leading-6 font-medium bg-blue-100 text-gray-900">Food Information</h3>
      <p class="mt-1 max-w-2xl text-sm text-gray-500">Item  details </p>
    </div>
    <div class="border-t border-gray-200">
      <dl>
        ...
        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
          <dt class="text-sm font-medium text-gray-500">Food ID</dt>
        ...
        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
          ...
          <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{bind_details.vendorprepartiontime}</dd>
        </div>
      </dl>
    </div>
  </div>;
              ...
              <div class="px-4 py-5 bg-white sm:p-6">
                <div class="grid grid-cols-6 gap-6">
                  <div class="col-span-6 sm:col-span-3">
                    <label for="first-name" class="block text-sm font-medium text-gray-700">Food</label>
...
const RenderDelete = () => {
  return <div class="relative inline-block right align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
