...
const Payments = () => {
    ...
    const Getpayments = (x) => {
        axios.get(baseUrl+'admin/getallpayments').then((res) => {
    ...
    const Getuserdetails = (user_id, type) => {
        axios.get(baseUrl+'user/getuserpayment/' + user_id).then((res) => {
            console.log(res.data, 'success');
    ...
    const RenderView = () => {
        ...
        return <div class="bg-white shadow overflow-hidden sm:rounded-lg rightt">
    ...
    const RenderEdit = () => {
        ...
        return <div>
          ...
          <div class="mt-10 sm:mt-0 rightt">
    
            <div class="px-4 sm:px-0">
              <h3 class="text-xl font-medium leading-6 text-blue-900">EDIT PAYMENT</h3>
            </div>
            <br></br>
