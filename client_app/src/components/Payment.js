...
const ShowDetails = (data, type) => {
  ...
  const RenderView = () => {
    ...
    return <div class="bg-white shadow overflow-hidden sm:rounded-lg right">
      <div class="px-4 py-5 sm:px-6">
        ...
        <p class="mt-1 max-w-2xl text-sm text-gray-500">Payment details and application.</p>
      </div>
      <div class="border-t border-gray-200">
        <dl>
          ...
          <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            <dt class="text-sm font-medium text-gray-500">order_id</dt>
            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{bind_user.order_id}</dd>
          </div>

          <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            <dt class="text-sm font-medium text-gray-500">payment_order_id</dt>
            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{bind_user.payment_order_id}</dd>
          </div>
          ...
          <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            ...
            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{bind_user.user_id}</dd>
          </div>
        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
          ...
          <div class="mt-5 md:mt-0 md:col-span-2">
            ...
            <h3 class="text-lg font-medium leading-6 text-gray-900">Payment Details</h3>
              <p class="mt-1 text-sm text-gray-600">Please fill the address to receive the payment.</p>
            </div>
          </div>
          <br/>
          <br/>
                  <div class="grid grid-cols-3 gap-3">
                    ...
                    <div class="col-span-3 sm:col-span-3">
                      ...
                      <input type="text" name="Address" id="email-address" autocomplete="address" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                    </div>
  ...
  const RenderDelete = () => {
    return <div class="relative inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full  right">
