...
const User = () => {
  ...
  const RenderView = () => {
    ...
    return <div class="bg-gray-100 shadow overflow-hidden sm:rounded-lg rights">
  ...
  const RenderEdit = () => {
    ...
    return <div>
      ...
      <div class="mt-10 sm:mt-0 rights">
  ...
  const RenderDelete = () => {
    return <div class=" rights relative inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
