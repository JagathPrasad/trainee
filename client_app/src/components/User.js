...
const User = () => {
  ...
  const RenderDelete = () => {
    return <div class="relative  inline-block align-bottom bg-green rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
