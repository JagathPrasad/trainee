    ...
    return (
        <>
            ...
            height="40">
                ...
                (
                    <div className={"duration-1000 top-0 left-0 h-screen fixed bg-black w-100sidebar w-60"}>
                        <hr />
                        ...
                        <div className="center">
                            <ul >
                                ...
                                <a
                                 href="#"
                                 class="flex flex-row items-center h-10 px-3 rounded-lg text-gray-300 hover:bg-gray-500 hover:text-gray-700"
                                 >
                                    {/* <div class="bt-group"> */}
